...
public class ds extends AppCompatActivity {
    ...
    String dow ;
    TextView time,load;
    String[] studentsList={"20MCS04","20MCS05","20MCS07","20MCS08","20MCS10",
            "20MCS11","20MCS18","20MCS19","20MCS21"};
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.logout:
                ...
                Intent intent1= new Intent(ds.this,TeacherLogin.class);
            ...
            case R.id.submit:
                ...
                if(count==size)
                {
                    Toast.makeText(ds.this, "ALL PRESENT", Toast.LENGTH_SHORT).show();
                }
                else if(count==0)
                {
                    Toast.makeText(ds.this, "ALL ABSENT", Toast.LENGTH_SHORT).show();
                }
                else {
